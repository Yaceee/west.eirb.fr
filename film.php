...
<body>
    <main class="bg-cream">
        ...
        <div class="container">
            <div class="video-container margin-vid" style="margin-top: 20px;">
                <iframe class="youtube-video" src="https://www.youtube.com/embed/ymQ9S6uP-CY?modestbranding=1&rel=0&showinfo=0" frameborder="0" modestbranding="1" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </main>
